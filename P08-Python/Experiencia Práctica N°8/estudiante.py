...
class Estudiante(object):
    ...
    def __init__(self, _codigo, _nombres, _apellidos, _edad, _curso1, _curso2, _curso3, _pension, _variable):
        self.codigo = _codigo
    ...
    def __del__(self):
        ...
        self.curso3 = ""
        self.pension = ""
        print("Se elimino la informacion")
    ...
    def eliminarEstudiante():
        ...
        codigo = int(input("Ingrese el número de código del estudiante: "))
        for objAlumno in listaEstudiante:
            if codigo == objAlumno.codigo:
                print(objAlumno.nombreCompleto)
                variable = bool()
                if variable == True:    
                    objAlumno.__del__(variable)
                    print("Se eliminó la información")
                    limpiar_pantalla()
                elif print("¡Incorrecto!"):
                    input("Presione cualquier tecla para salir")
                    limpiar_pantalla()
                    pass
...
def main():
    while True:
        ...
        print("6.- Eliminar a un Estudiante")
        print("7.- Salir\n")
